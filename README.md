...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-leo/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-leo/actions/workflows/validate.yml)

Neovim tree-sitter queries for **leo**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-leo",
...
- [ ] Changes are scoped to `leo` — do not include files for other languages
